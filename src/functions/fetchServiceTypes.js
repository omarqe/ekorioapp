...
export default function fetchServiceTypes(setState, setLoading, setData, setLoadingData, excludes = []) {
            ...
            if (services?.length > 0) {
                const routes = services.map(({ id, name: label }, i) => {
                    ...
                    if (i === 0 && typeof setData === "function" && typeof setLoadingData === "function") {
                        _fetchAppointments(key, id, {}, setData, setLoadingData, excludes);
                    }
